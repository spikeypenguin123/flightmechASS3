function [aircraft] = Initialisation_With_State(cg,speed,debug, state)
    ...
    aircraft.state = {};
    aircraft.state.u = state(1);
    aircraft.state.v = state(2);
    aircraft.state.w = state(3);
    aircraft.state.p = state(4);
    aircraft.state.q = state(5);
    aircraft.state.r = state(6);
    aircraft.state.quat = [state(7);state(8);state(9);state(10)];
    aircraft.state.x_e = state(11);
    aircraft.state.y_e = state(12);
    aircraft.state.z_e = state(13);
